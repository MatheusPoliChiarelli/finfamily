...
class PieceTypes {
  static const all = <PieceType>[
    ...
    PieceType(id: 'short_saia', name: 'Short-Saia', icon: Icons.filter_none_outlined),
    ...
    PieceType(id: 'calca_jeans', name: 'Calça Jeans', icon: Icons.straighten_outlined),
    PieceType(id: 'calca_pantalona', name: 'Calça Pantalona', icon: Icons.waves_outlined),
    PieceType(id: 'calca_alfaiataria', name: 'Calça Alfaiataria', icon: Icons.content_cut_outlined),
    PieceType(id: 'blusa', name: 'Blusa', icon: Icons.woman_outlined),
    PieceType(id: 'camisa', name: 'Camisa', icon: Icons.dry_cleaning_outlined),
    ...
    PieceType(id: 'conjunto_saia', name: 'Conjunto Saia', icon: Icons.layers_outlined),
